...
export const getToggleList = (renderedComponent: RenderResult) => renderedComponent.getByTestId('tab-toggle-list');
...
export const getSectionsList = (renderedComponent: RenderResult) => renderedComponent.getByTestId('tab-content-list');
